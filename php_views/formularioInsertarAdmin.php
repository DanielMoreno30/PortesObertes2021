<?php
    ...
    if(isset($_SESSION['usuarioInsertar']))
    {
        $usuario = $_SESSION['usuarioInsertar'];
        unset($_SESSION['usuarioInsertar']);
    }
?>
...
>>>>>>> 1f1be764faa7fc79fa7fda01bfb8f98fb1c5723e
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            value="<?php if(isset($usuario['nombreUsuario'])){ echo $usuario['nombreUsuario']; } ?>">
                        </div>
                    </div>
...
>>>>>>> 1f1be764faa7fc79fa7fda01bfb8f98fb1c5723e
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            value="<?php if(isset($usuario['contra'])){ echo $usuario['contra']; } ?>">
                        </div>
                    </div>
...
>>>>>>> 1f1be764faa7fc79fa7fda01bfb8f98fb1c5723e
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            value="<?php if(isset($usuario['nombre'])){ echo $usuario['nombre']; } ?>">
                        </div>
                    </div>
...
>>>>>>> 1f1be764faa7fc79fa7fda01bfb8f98fb1c5723e
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            value="<?php if(isset($usuario['apellidos'])){ echo $usuario['apellidos']; } ?>">
                        </div>
                    </div>
...
>>>>>>> 1f1be764faa7fc79fa7fda01bfb8f98fb1c5723e
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            value="<?php if(isset($usuario['correo'])){ echo $usuario['correo']; } ?>">
                        </div>
                    </div>
...
>>>>>>> 1f1be764faa7fc79fa7fda01bfb8f98fb1c5723e
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="checkTipo[]" id="usuarioAdmin" value="A" checked disabled>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <input type="submit" class="btn btn-primary ms-2" name="insertarAdmin" value="Aceptar">
                    </div>
                </form>
            </div>
        </div>
