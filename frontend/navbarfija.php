    ...
    <div class="container fluid">
          ...
          <div id="main-nav" class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto">
              ...
              <li>
                <a href="./games.php" class="nav-item nav-link">Jocs</a>
              </li>
              <li>
                <a href="./aboutus.php" class="nav-item nav-link">Sobre Nosaltres</a>
              </li>
              <li><a href="./formcontacto.php" class="nav-item nav-link">Contacte</a></li>
              <li>
